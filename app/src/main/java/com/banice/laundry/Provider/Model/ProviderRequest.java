...
public class ProviderRequest {
    ...
    public ProviderRequest(String request_time_surge, String request_provider_service_id, String request_pick_up_location, String request_id, String request_customer_id) {

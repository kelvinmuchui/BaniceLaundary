...
public class ModelRequests {
    ...
    String request_customer_id;
    String request_pick_up_location;
    String request_provider_service_id;
    String request_time_surge;

    public ModelRequests() {
    }

    public ModelRequests(String request_customer_id, String request_pick_up_location, String request_provider_service_id, String request_time_surge) {

...
import com.banice.laundry.Provider.Fragments.MyRequestsFragment;
import com.banice.laundry.Provider.Fragments.MyServicesFragment;
...
public class ProviderActivity extends AppCompatActivity
    ...
    public boolean onOptionsItemSelected(MenuItem item) {
        ...
        if (id == R.id.action_logout) {
            ...
            return true;
        } else if (id == R.id.action_addService) {
